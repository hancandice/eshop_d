    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Starters', 'Starters'), ('Main dishes', 'Main dishes'), ('Desserts', 'Desserts'), ('Drinks', 'Drinks')], max_length=30)),
                ('label', models.CharField(blank=True, choices=[('Vegan', 'Vegan'), ('Gluten Free', 'Gluten-free'), ('Michelin Starred', 'Michelin-starred')], max_length=30, null=True)),
